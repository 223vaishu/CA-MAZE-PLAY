//I have been using minmax for the limit 
Math.minmax = (value, limit) => {
  ...
  //Creating a function for a mouse to move.
  ...
  //function for reset the game after the game is lost.
  function resetGame() {
  ...
  function main(timestamp) {
    ...
    try {
      ...
      var save = localStorage.getItem("save",save)
      ...
      if (
        ...
        noteElement.innerHTML = `Congrats `+ save +` , YOU WON THE GAME!<br>Think it was quite easy for you..
      ...
      if (error.message == "The ball fell into a hole") {
        noteElement.innerHTML = `A ball fell into a black hole!<br> Press space to reset the game.
          <p>
...
//Created a restart button to restart the game from the first index page.
...
const backgroundAudio = new Audio("gamemusic-6082.mp3");
